  ...
  return (
    <Container>
        <SubscriptionForm>
            ...
            <h6>Do you have a suggestion / found some bug. Do let us know in the form below</h6>
            <Form>
                <Field placeholder='Feedback message'/>
                <Button style={{textDecoration: 'none'}}>Submit</Button>
            </Form>
        </SubscriptionForm>
